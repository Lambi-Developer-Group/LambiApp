...
public final class ActivityAboutBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvLambi;

  private ActivityAboutBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvLambi) {
    this.rootView = rootView;
    this.tvLambi = tvLambi;
  }
  ...
  public static ActivityAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tv_lambi;
      TextView tvLambi = ViewBindings.findChildViewById(rootView, id);
      if (tvLambi == null) {
        break missingId;
      }

      return new ActivityAboutBinding((ConstraintLayout) rootView, tvLambi);
    }
