...
public final class ItemSessionBinding implements ViewBinding {
  ...
  private ItemSessionBinding(@NonNull CardView rootView, @NonNull TextView textViewSession) {
  ...
  public static ItemSessionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.textViewSession;
      TextView textViewSession = ViewBindings.findChildViewById(rootView, id);
      if (textViewSession == null) {
        break missingId;
      }

      return new ItemSessionBinding((CardView) rootView, textViewSession);
    }
